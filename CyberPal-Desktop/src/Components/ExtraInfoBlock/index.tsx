  ...
  return (
    <div className='extra-info-block'>
        ...
        <div className='extra-info-cards-block'>
            <ExtraInfoCard title="Integrated Tools" description="CyberPal integrates popular cybersecurity tools, providing a unified platform for enhanced security management." button_label="View Tools" color="blue" icon="pi-wrench" />
            ...
            <ExtraInfoCard title="Automation & Scripts" description="Leverage the power of automation and custom scripts to improve efficiency and streamline security operations." button_label="Discover Automation" color="cyan" icon="pi-file-edit" />
        </div>
    </div>  
  )
}
