  ...
  return (
    <div className='extra-info-block'>
        ...
        <div className='extra-info-cards-block'>
            <ExtraInfoCard title="Information Title" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit." button_label="click here" color="blue" />
            <ExtraInfoCard title="Information Title" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit." button_label="click here" color="pink" />
